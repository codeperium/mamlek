...
<header class="hero mb-15">
    <div class="container hero-gradient py-10 px-5">
        <h2 class="mb-7">
    ...
    <div class="container">
                        ...
                        <Card.Content>
                            <Card.Title>
                                <Item.Root>
                                    ...
                                    <Item.Content>
                                        Kiedy dziecko choruje, liczy się czas -
                                        a Ty nie wiesz, w której aptece lek jest
                                        dostępny.
                                    </Item.Content>
                                </Item.Root>
                            </Card.Title>
                            <Card.Description>
                                W aplikacji sprawdzasz dostępność leków w
                                pobliżu i od razu widzisz, <strong
                                    >gdzie warto jechać.</strong
                                >
                            </Card.Description>
                        </Card.Content>
                    </Card.Root>
                ...
                <article class="card xl:max-w-[45%]">
                    <Card.Root>
                        <Card.Content>
                            ...
                            <Card.Description>
                                Aplikacja w sekundę <strong
                                    >porównuje ceny</strong
                                >
        ...
        <section class="context mb-15">
            ...
            <p class="mb-3 xl:mb-6">
                Masz milion spraw na głowie: praca, dom, dziecko, zakupy, a do
                tego nagle gorączka o 21:30. <br /> W takich momentach nie
                chcesz robić researchu po stronach aptek ani jeździć „na ślepo”.<br
                />
                Ta aplikacja jest po to, żebyś w jednym miejscu zobaczyła
                    ...
                    <ul class="what-is-solution">
                        <li>
                            <Item.Root>
                                ...
                                <Item.Content>
                                    ...
                                    dostępności leków w aptekach w Twojej
                                    okolicy.
                                </Item.Content>
                            </Item.Root>
                        </li>
                        <li>
                            <Item.Root>
                                ...
                                <Item.Content>
                                    Szybka pomoc w decyzji: gdzie kupić, żeby
                                    nie tracić czasu i nie przepłacać.
                                </Item.Content>
                            </Item.Root>
                        </li>
                    </ul>
                    ...
                    <ul class="what-is-not-solution">
                        <li>
                            <Item.Root>
                                ...
                                <Item.Content>
                                    Nie jest apteką online - nie sprzedaje leków
                                    i nie realizuje zamówień.
                                </Item.Content>
                            </Item.Root>
                        </li>
                        <li>
                            <Item.Root>
                                ...
                                <Item.Content>
                                    Nie zastępuje porady lekarza - pomaga w
                                    zakupie, ale nie diagnozuje i nie dobiera
                                    leczenia.
                                </Item.Content>
                            </Item.Root>
                        </li>
        ...
        <section id="email-form" class="breakpoint pb-20">
            ...
            {#if !isSuccess && !isError}
                <form
                    method="post"
                    class="flex flex-col align-center xl:flex-row"
                >
            ...
            {:else}
                <p class="message">
                    Wystąpił błąd podczas wysyłania powiadomienia. Spróbuj
                    ponownie później.
                </p>
            {/if}
        </section>
...
<style lang="postcss">
    ...
    header {
        ...
        background-position: right -350px bottom 100%;
        background-size: 250%;
    }
    ...
    @media (width >= 80rem) {
        header {
            padding: 100px;
            /*min-height: 420px;*/
            background-position: right 0px bottom 55%;
